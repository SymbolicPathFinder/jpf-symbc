...
public class StringContainsIfNullTest {
    ...
    // Test 4: self contains check - branch check (arg != null) => (IFNULL)
    public static void testSelfNotNull1() {
        String str = Verifier.nondetString();
        if (str != null) {
            System.out.println("str is not null");
            if (str.contains(str)) {
    ...
    // Test 4: self contains check - branch check (arg == null) => (IFNULL)
    public static void testSelfNotNull2() {
        String str = Verifier.nondetString();
        if (str != null) {
            System.out.println("str is not null");
        } else {
            System.out.println("str is null");
            if (str.contains(str)) {
                System.out.println("Test 5: Then Side");
            } else {
                System.out.println("Test 5: Else Side");
            }
        }
    }
}
