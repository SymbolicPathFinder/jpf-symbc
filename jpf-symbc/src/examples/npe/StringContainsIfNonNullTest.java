...
public class StringContainsIfNonNullTest {
    ...
    // Test 4: self contains check - branch check (arg == null) => (IFNONNULL)
    public static void testSelfNull1() {
        String str = Verifier.nondetString();
        if (str == null) {
            System.out.println("str is null");
            if (str.contains(str)) {
    ...
    // Test 5: self contains check - branch check (arg == null) => (IFNONNULL)
    public static void testSelfNull2() {
        String str = Verifier.nondetString();
        if (str == null) {
            System.out.println("str is null");
        } else {
