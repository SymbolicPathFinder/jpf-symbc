...
public class Z3_3 {
	...
	public static String getBinary() {
		return getProperties().getProperty("strings.z3", "/usr/local/bin/z3");
	}

	public static String getInteractive() {
		return getBinary() + " " + getProperties().getProperty("strings.interactive_flags", " -smt2 -file:./temp.z3str smt.string_solver=z3str3");
	}

	public static boolean saveTempFileAfterRun() {
		return getProperties().getProperty("strings.keep_temp", "yes").equalsIgnoreCase("yes");
	}
